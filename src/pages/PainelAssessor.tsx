  ...
  const handleCriarEleitor = async () => {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        logradouro: eleitorForm.rua || null,
        numero: eleitorForm.numero || null,
        complemento: eleitorForm.complemento || null,
        bairro: eleitorForm.bairro || null,
        cidade: eleitorForm.cidade || null,
        estado: eleitorForm.estado || null,
        cep: eleitorForm.cep || null,
